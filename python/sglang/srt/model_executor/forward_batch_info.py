...
class ForwardBatch(ForwardBatchDeepSeekMHAMixin):
    ...
    # Fresh only for non-speculative extend, or QSA HiSparse decode, whose
    # lease coordinator requires the CPU request identities.
        ...
        ret = cls(
            ...
            req_pool_indices_cpu=(
                ...
                or (
                    ...
                    and getattr(
                        getattr(batch, "hisparse_coordinator", None),
                        "uses_qsa_hisparse_leases",
                        False,
                    )
                )
                else None
